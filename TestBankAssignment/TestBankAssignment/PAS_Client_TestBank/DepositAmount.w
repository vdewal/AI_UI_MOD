...
&Scoped-Define ENABLED-OBJECTS RECT-17 RECT-18 FILL-IN-ToAccount ~
FILL-IN-TxnId FILL-IN-DepositDate COMBO-BOX-Source FILL-IN-Amount ~
Btn_Cancel 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-ToAccount FILL-IN-TxnId ~
FILL-IN-DepositDate COMBO-BOX-Source FILL-IN-Amount 
...
DEFINE VARIABLE FILL-IN-DepositDate AS DATE FORMAT "99/99/99":U 
     LABEL "Deposit Date" 
     VIEW-AS FILL-IN 
     SIZE 23 BY 1
     FONT 2 NO-UNDO.

DEFINE VARIABLE FILL-IN-ToAccount AS INTEGER FORMAT "->,>>>,>>9":U INITIAL 0 
     LABEL "AccountNum" 
     VIEW-AS FILL-IN 
     SIZE 23 BY 1
     FONT 2 NO-UNDO.
...
DEFINE FRAME gDialog
     FILL-IN-ToAccount AT ROW 2.75 COL 16 COLON-ALIGNED WIDGET-ID 14
     FILL-IN-TxnId AT ROW 4 COL 16 COLON-ALIGNED WIDGET-ID 16
     FILL-IN-DepositDate AT ROW 5.5 COL 16 COLON-ALIGNED WIDGET-ID 2
     COMBO-BOX-Source AT ROW 7 COL 16 COLON-ALIGNED WIDGET-ID 8
     FILL-IN-Amount AT ROW 8.25 COL 16 COLON-ALIGNED WIDGET-ID 4
     Btn_OK AT ROW 10 COL 4
     Btn_Cancel AT ROW 10 COL 27
     "DEPOSIT AMOUNT" VIEW-AS TEXT
          SIZE 24 BY 1 AT ROW 1.25 COL 11 WIDGET-ID 18
          FONT 5
     RECT-17 AT ROW 2.5 COL 4 WIDGET-ID 20
     RECT-18 AT ROW 2.25 COL 3 WIDGET-ID 22
     SPACE(1.74) SKIP(0.33)
...
/* SETTINGS FOR BUTTON Btn_OK IN FRAME gDialog
   NO-ENABLE                                                            */
ASSIGN 
       FILL-IN-DepositDate:READ-ONLY IN FRAME gDialog        = TRUE.

ASSIGN 
       FILL-IN-ToAccount:READ-ONLY IN FRAME gDialog        = TRUE.
...
ON WINDOW-CLOSE OF FRAME gDialog /* Deposit Amount */
DO:  
...
ON CHOOSE OF Btn_OK IN FRAME gDialog /* Deposit */
DO:
        ...
        ASSIGN
            ...
            ttSavingAccountTxnHistory.TxnDate       = DATE(FILL-IN-DepositDate:SCREEN-VALUE)
            ttSavingAccountTxnHistory.DepositAmount = DECIMAL(FILL-IN-Amount:SCREEN-VALUE)
        ...
        oUtility:getInputParameterStructure(INPUT "AddDeposit",INPUT "",INPUT 0, INPUT TEMP-TABLE ttSavingAccountTxnHistory:HANDLE, OUTPUT oInputJson).
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-ToAccount FILL-IN-TxnId FILL-IN-DepositDate COMBO-BOX-Source 
          FILL-IN-Amount 
      WITH FRAME gDialog.
  ENABLE RECT-17 RECT-18 FILL-IN-ToAccount FILL-IN-TxnId FILL-IN-DepositDate 
         COMBO-BOX-Source FILL-IN-Amount Btn_Cancel 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
...
/*------------------------------------------------------------------------------
    ...
    DO WITH FRAME {&FRAME-NAME}: 
        FILL-IN-ToAccount:READ-ONLY      =       TRUE.
        FILL-IN-DepositDate:READ-ONLY    =       TRUE.
        FILL-IN-TxnId:READ-ONLY          =       TRUE .
        FILL-IN-ToAccount:SCREEN-VALUE = STRING(iAccNum).
        FILL-IN-DepositDate:SCREEN-VALUE = STRING(TODAY).
